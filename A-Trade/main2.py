'''
Тестирование на SBER. Столбец datetime как в файле. Работает.
'''
...
import Strategy2 as ts  # Торговые системы
...
if __name__ == '__main__':
    ...
    datapath = os.path.join(modpath, 'Data/SBER_D1.csv')

    # print(datapath)
    # exit(1)

    data = pd.read_csv(datapath, sep=',', index_col='datetime')    # this data is from metatrader 5
    print(data)
    ...
    # Add a strategy
    cerebro.addstrategy(TestStrategy01)
